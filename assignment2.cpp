...
csX75::HNode * square(csX75::HNode * parent)
{
  tri_idx=0; 
  glm::vec4 v_positions[6];
  glm::vec4 v_colors[6];
  positions[0] = glm::vec4(0.5,-0.5,0.5, 1.0);
  positions[1] = glm::vec4(0.5,-0.5,-0.5, 1.0);
  positions[2] = glm::vec4(-0.5,-0.5,-0.5, 1.0);
  positions[3] = glm::vec4(-0.5,-0.5,0.5, 1.0);
...
csX75::HNode * top(csX75::HNode * parent)
{
  tri_idx=0; 
  glm::vec4 v_positions[6];
  glm::vec4 v_colors[6];
  positions[0] = glm::vec4(0.0,0.0,0.5, 1.0);
  positions[1] = glm::vec4(0.0,0.0,-0.5, 1.0);
  positions[2] = glm::vec4(-1,0.0,-0.5, 1.0);
  positions[3] = glm::vec4(-1,-0.0,0.5, 1.0);
  quad(0,1,2,3,v_positions,v_colors);
...
///////////   BOX  V ////////
  setColor(yellow);
  rr = square(NULL);
  rr->change_parameters(4,0,0,0,0,0);
  ...
  setColor(skin);
  rr6 = top(rr);
  rr6->change_parameters(0.5,0.5,0,0,0,0);



  root_node = curr_node = hip;
